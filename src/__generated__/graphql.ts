...
export type GetMyInvitesQuery = { __typename?: 'Query', getMyInvites: { __typename?: 'TeamInvitesResponse', results?: Array<{ __typename?: 'TeamInvite', _id: string, email?: string | null, role: TeamRole, status: InviteStatus, method: InviteMethod, expiresAt: string, createdAt: string, skills?: Array<string> | null, invitedBy: { __typename?: 'User', _id: string, firstName?: string | null, lastName?: string | null }, team: { __typename?: 'WorshipTeam', _id: string, name: string } }> | null, errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null } };
