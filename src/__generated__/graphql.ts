...
export type GetNfcConfigQuery = { __typename?: 'Query', getNFCConfig: { __typename?: 'NFCConfig', _id: string, url: string, title: string, description: string, nfcIds: Array<string>, createdAt: string, updatedAt: string, owner: { __typename?: 'User', _id: string }, socialMedia: { __typename?: 'SocialMediaSettings', facebook: boolean, instagram: boolean, twitter: boolean }, givingLink?: { __typename?: 'LinkSettings', isVisible: boolean, url: string } | null, memberRegistrationLink?: { __typename?: 'LinkSettings', isVisible: boolean, url: string } | null, eventsLink?: { __typename?: 'LinkSettings', isVisible: boolean, url: string } | null } };
